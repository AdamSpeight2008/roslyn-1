    ...
    Partial Friend Class Binder
        ...
        Private Function BindLetClause(
            ...
            For i = If(skipFirstVariable, 1, 0) To variables.Count - 1
                ...
                Bind_Internal_LetClause(source, clauseSyntax, operatorsEnumerator, diagnostics, suppressDiagnostics, callDiagnostics, variables, i)
            Next
        ...
        Private Sub Bind_Internal_LetClause(
                                       ByRef source As BoundQueryClauseBase,
                                             clauseSyntax As LetClauseSyntax,
                                             operatorsEnumerator As SyntaxList(Of QueryClauseSyntax).Enumerator,
                                             diagnostics As DiagnosticBag,
                                       ByRef suppressDiagnostics As DiagnosticBag,
                                       ByRef callDiagnostics As DiagnosticBag,
                                       ByRef variables As SeparatedSyntaxList(Of ExpressionRangeVariableSyntax),
                                             i As Integer)
