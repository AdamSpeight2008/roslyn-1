    ...
    Partial Friend Class Binder
        ...
        Public Function BindExpression(
            ...
            Select Case node.Kind
                ...
                'Case SyntaxKind.TypeOfIsManyExpression,
                ...
                Case SyntaxKind.IntoVariableExpression
                    Return BindIntoVariableExpression(DirectCast(node, IntoVariableExpressionSyntax), diagnostics)
        ...
        ') As BoundCaseClause
          ...
          '  locals.Add(local)
            ...
            Else
                ...
                Dim useSiteDiagnostics = CompoundUseSiteInfo(Of AssemblySymbol).Discarded
                ...
                If useSiteDiagnostics.HasErrors Then
                    hasErrors = True
                End If
