...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Friend NotInheritable Class IteratorAndAsyncCaptureWalker
        ...
        Public Structure Result
            ...
            Public ReadOnly ByRefLocalsInitializers As PooledObjects.PooledDictionary(Of LocalSymbol, BoundExpression)

            Friend Sub New(cl As OrderedSet(Of Symbol), initializers As PooledObjects.PooledDictionary(Of LocalSymbol, BoundExpression))
                CapturedLocals = cl
        ...
        Public Sub New(info As FlowAnalysisInfo)
            ...
            _byRefLocalsInitializers = PooledObjects.PooledDictionary(Of LocalSymbol, BoundExpression).GetInstance
        End Sub
