...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Friend Structure RegionAnalysisContext
        ...
        Friend Sub New(
                        ...
                        member          As Symbol,
                        boundNode       As BoundNode,
                        firstInRegion   As BoundNode,
                        lastInRegion    As BoundNode,
                        region          As textspan
                      )
            ...
            Failed = _symbol Is Nothing OrElse _boundNode Is Nothing OrElse 
                     _firstInRegion Is Nothing OrElse _lastInRegion Is Nothing
