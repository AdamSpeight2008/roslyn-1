...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Friend MustInherit Class AbstractFlowPass(Of LocalState As AbstractLocalState)
        ...
        ''' </summary>
        Private ReadOnly _labels As PooledDictionary(Of LabelSymbol, LabelStateAndNesting) =
        ...
        Private _labelsSeen As PooledHashSet(Of LabelSymbol) =
            PooledHashSet(Of LabelSymbol).GetInstance
        ...
        Protected Sub SetPlaceholderSubstitute(placeholder As BoundValuePlaceholderBase, newSubstitute As BoundExpression)
            ...
            If _placeholderReplacementMap Is Nothing Then
                _placeholderReplacementMap = PooledDictionary(Of BoundValuePlaceholderBase, BoundExpression).GetInstance
            End If
