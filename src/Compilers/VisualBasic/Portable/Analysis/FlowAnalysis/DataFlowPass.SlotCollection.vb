    ...
    Friend Partial Class DataFlowPass
        ...
        Protected Structure SlotCollection
            ...
            Public ReadOnly Property Count As Integer
                Get
                    If _builder IsNot Nothing Then Return _builder.Count
            ...
            Default Public Property Item(index As Integer) As Integer
                Get
                    ...
                    If _builder IsNot Nothing Then Return _builder(index)
                    Return _singleValue
                End Get
                Set(value As Integer)
                    Debug.Assert(index >= 0 AndAlso index < Count)
                    Debug.Assert(value <> SlotKind.Unreachable)
                    If _builder IsNot Nothing Then _builder(index) = value
                    _singleValue = value
                End Set
            End Property
