...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Friend Structure BoundNodeSummary
        ...
        ''' <summary> The lowest bound node in the bound tree associated with a particular syntax node. </summary>
        Public ReadOnly LowestBoundNode As BoundNode

        ''' <summary> The highest bound node in the bound tree associated with a particular syntax node. </summary>
