...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Friend Module VBResources
        ...
        '''<summary>
        '''  Looks up a localized string similar to Expected &apos;When&apos;.
        '''</summary>
        Friend ReadOnly Property ERR_ExpectedWhenKeyword() As String
            Get
                Return ResourceManager.GetString("ERR_ExpectedWhenKeyword", resourceCulture)
            End Get
        End Property
