...
Public Class SyntaxFactsTests
    ...
    Public Sub GetContextualKeywordKind()
        ...
        Dim expected = {"aggregate", "all", "ansi", "ascending", "assembly",
                        "async", "auto", "await", "binary", "by",
                        "compare", "custom", "descending", "distinct", "equals",
                        "explicit", "externalsource", "externalchecksum", "from", "group",
                        "infer", "into", "isfalse", "istrue", "iterator",
                        "join", "key", "mid", "off", "order",
                        "out", "preserve", "r", "region", "skip",
                        "strict", "take", "text", "unicode", "until",
                        "where", "type", "xml", "yield", "enable",
                        "disable", "warning", "checked", "unchecked"}
